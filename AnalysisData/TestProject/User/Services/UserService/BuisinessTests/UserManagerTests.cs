...
public class UserManagerTests
{
    ...
    public async Task GetUserAsync_ShouldReturnUser_WhenUserExists()
    {
        ...
        var expectedUser = new AnalysisData.User.Model.User() { Id = userId , Username = "testUser" };
    ...
    {
        // Arrange
        var user = new AnalysisData.User.Model.User { Id = Guid.NewGuid(), Email = "info@example.com", FirstName = "sdas", LastName = "asdsdqss"};
        ...
        _userRepository.GetUserByEmailAsync("info2@example.com").Returns((AnalysisData.User.Model.User)null);
    ...
    {
        // Arrange
        var user = new AnalysisData.User.Model.User() { Id = Guid.NewGuid(), Email = "info@gmail.com" };
        var updateUserDto = new UpdateUserDto
        {
            FirstName = "NewFirstName",
            LastName = "NewLastName",
        ...
        var existingUser = new AnalysisData.User.Model.User() { Id = Guid.NewGuid(), Email = "info2@gmail.com" };
